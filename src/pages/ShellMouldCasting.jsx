...
/* Copper Alloy – Shell Mould (8) */
import Cu1 from "../assets/ShellMould/cu1.webp";
import Cu2 from "../assets/ShellMould/cu2.webp";
import Cu3 from "../assets/ShellMould/cu3.webp";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[Cu1, Cu2, Cu3].map((img, i) => (
              <div key={i} className="border rounded-lg bg-white shadow-sm hover:shadow-md flex items-center justify-center">
                <img src={img} alt="Shell Mould Copper Alloy Casting" className="w-full h-40 sm:h-48 md:h-56 lg:h-64 object-contain bg-gray-50" />
              </div>
            ))}
          </div>
        </section>
...
export default ShellMouldCasting;
